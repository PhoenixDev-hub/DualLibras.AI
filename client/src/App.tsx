...
function App() {
  ...
  return (
    <main className="relative min-h-screen w-screen overflow-hidden bg-black text-[#F2F6FF] font-sans">
      ...
      >
        <div className="z-10 w-full overflow-hidden rounded-lg border border-[#82E3FF]/25 bg-[linear-gradient(180deg,rgba(3,26,92,0.80),rgba(2,11,43,0.92))] shadow-[0_24px_80px_rgba(2,11,43,0.76),0_0_0_1px_rgba(83,184,255,0.08)] backdrop-blur-md">
          <div
