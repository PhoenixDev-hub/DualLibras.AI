      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              to="/entrar"
              className="inline-flex items-center px-7 py-3.5 text-text-light font-ui font-semibold tracking-wide rounded-full border border-text-light/30 hover:bg-background-dark/20 hover:scale-[1.03] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-text-light focus-visible:ring-offset-2 focus-visible:ring-offset-primary"
            >
              Entrar
            </Link>
          </div>
