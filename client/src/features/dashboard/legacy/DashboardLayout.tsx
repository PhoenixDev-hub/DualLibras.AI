...
export default function DashboardLayout({
  ...
  const [activeSection, setActiveSection] = useState<DashboardSection>(
    dashboard.access.sections[0] ?? 'Dashboard',
  )
        ...
        <section className="fixed inset-0 z-50 grid place-items-center bg-slate-950/60 px-4 py-6">
          <article className="w-full max-w-2xl rounded-lg border border-slate-200 bg-white p-5 shadow-xl dark:border-slate-800 dark:bg-slate-900">
            <header className="flex items-start justify-between gap-4">
              <section>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Crie uma sala para aulas, palestras ou encontros sociais com suporte a voz para
                  Libras.
                </p>
              </section>
              <button
            ...
            <form
              ...
              className="mt-5 grid gap-4 md:grid-cols-[1fr_auto] md:items-end"
            >
          ...
          <article className="w-full max-w-2xl rounded-lg border border-slate-200 bg-white p-5 shadow-xl dark:border-slate-800 dark:bg-slate-900">
            <header className="flex items-start justify-between gap-4">
              <section>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-600 dark:text-slate-300">
                  Envie PDF, Word, PowerPoint ou Texto para apoiar a transcrição e a tradução voz
                  para Libras.
                </p>
              </section>
              <button
