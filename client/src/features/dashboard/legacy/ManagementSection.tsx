      ...
      <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        {canUse(content.primaryCapability) && (
          <button
            ...
            className="inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-blue-700 px-5 text-sm font-bold text-white shadow-lg shadow-blue-700/20 transition hover:bg-blue-800"
          >
        ...
        <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <ul className="mt-4 space-y-3">
            {content.rows.map((row) => (
              <li
                key={row.title}
                className="flex flex-col gap-3 rounded-lg border border-slate-100 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950 sm:flex-row sm:items-center sm:justify-between"
              >
                <span>
        ...
        <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <ul className="mt-4 space-y-3">
            {content.asideItems.map((item) => (
              <li
                key={item}
                className="flex min-h-12 items-center gap-3 rounded-lg border border-slate-100 p-3 text-sm font-bold text-slate-800 dark:border-slate-800 dark:text-slate-100"
              >
