...
import { quickActions, recentActivity, stats, upcomingClasses } from './dashboardData'

const weeklyClasses = [58, 76, 64, 92, 83, 108, 96]
const transcriptionTime = [34, 48, 42, 61, 57, 72, 66]
    ...
    <>
      ...
      <section className="mt-7 grid gap-5 xl:grid-cols-2" aria-label="Estatísticas detalhadas">
        <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <BarChart values={weeklyClasses} label="Aulas realizadas por semana" />
        </article>
        ...
        <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <BarChart values={transcriptionTime} label="Tempo total de transcrição" />
        </article>
      </section>
    </>
  )
