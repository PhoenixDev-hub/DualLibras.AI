...
class DocumentationGenerator:
    ...
    def generate_project_documentation(
        ...
        try:
            ...
            story.append(
                Paragraph(
                    "O <b>Festival 2026</b> reúne um protótipo de transcrição de áudio, integração com o widget "
                    "VLibras no navegador e uma demonstração visual do professor. Este PDF tem conteúdo "
                    "estático; contratos, instalação e limitações atuais estão nos arquivos README e docs do repositório.",
                    body_style,
                )
            )
            story.append(Spacer(1, 0.2 * inch))
            ...
            features = [
                "- <b>Transcrição em Tempo Real:</b> Captura e transcreve áudio em português via AssemblyAI ou Faster-Whisper",
                "- <b>Integração Libras:</b> Widget externo no frontend; o serviço Python entrega texto",
                "- <b>Exportação:</b> PDF, TXT e JSON sob demanda; exportação automática por trecho é opcional",
                ...
                "- <b>Interface Web:</b> Protótipo de transcrição e dashboard do professor com dados fictícios",
            ]
