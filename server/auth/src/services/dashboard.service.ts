...
const dashboardData = {
  stats: [
    { label: 'Aulas de Matemática', value: '128', detail: '+12 neste mês', icon: 'Video' },
    {
      label: 'Turmas ativas',
      value: '18',
      detail: 'Ensino médio e extensão',
      icon: 'GraduationCap',
    },
  ...
  managementSections: {
    'Minhas Turmas': {
      ...
      rows: [
        {
          title: '2º Ano A',
          detail: 'Matemática • 32 alunos',
          meta: 'Transcrição automática ativa',
          action: 'Configurar',
          capability: 'editClass',
        },
        {
          title: '3º Ano B',
          detail: 'Matemática • 28 alunos',
          meta: 'Glossário compartilhado',
          action: 'Convidar',
          capability: 'editClass',
        },
        {
          title: 'Extensão',
          detail: 'Introdução à IA • 46 alunos',
          meta: 'Acesso por convite',
          action: 'Abrir',
          capability: 'joinClass',
        },
      ],
      ...
      rows: [
        {
          ...
          detail: '2º Ano A • Hoje 14:00',
          meta: 'Pronta para iniciar',
          action: 'Iniciar',
          capability: 'startTranscription',
        },
        {
          title: 'Geometria plana',
          detail: '3º Ano B • Hoje 16:20',
          meta: 'Material anexado',
          action: 'Abrir',
          capability: 'startTranscription',
        },
        {
          title: 'Estatística aplicada',
          detail: 'Extensão • Amanhã 09:30',
          meta: 'Roteiro pendente',
          action: 'Preparar',
          capability: 'createLesson',
        },
      ],
    ...
    Materiais: {
      title: 'Materiais',
      description:
        'Envie PDFs, PPTs e DOCXs para apoiar transcrição, resumo e adaptação das aulas.',
      primaryAction: 'Fazer upload',
      primaryCapability: 'uploadMaterial',
      icon: 'Upload',
      rows: [
        {
          title: 'Lista de exercícios.pdf',
          detail: '2º Ano A • PDF',
          meta: 'Enviado hoje',
          action: 'Abrir',
        },
        {
          title: 'Geometria plana.pptx',
          detail: '3º Ano B • PPT',
          meta: 'Usado em aula',
          action: 'Baixar',
        },
        {
          title: 'Roteiro estatística.docx',
          detail: 'Extensão • DOCX',
          meta: 'Aguardando revisão',
          action: 'Revisar',
          capability: 'linkMaterial',
        },
      ],
    ...
    Glossários: {
      title: 'Glossários',
      description:
        'Organize termos da disciplina para melhorar consistência da tradução e dos resumos.',
      ...
      rows: [
        {
          title: 'Álgebra',
          detail: '48 termos cadastrados',
          meta: 'Atualizado ontem',
          action: 'Editar',
          capability: 'editGlossary',
        },
        {
          title: 'Geometria',
          detail: '36 termos cadastrados',
          meta: 'Compartilhado com 2 turmas',
          action: 'Abrir',
        },
        {
          title: 'Estatística',
          detail: '22 termos cadastrados',
          meta: 'Em construção',
          action: 'Continuar',
          capability: 'editGlossary',
        },
      ...
      asideItems: [
        ...
        'Sinais e explicações em Libras',
        'Padronização entre turmas',
      ],
    },
    Histórico: {
      title: 'Histórico',
      ...
      rows: [
        {
          ...
          detail: '2º Ano A • 52 min',
          meta: 'Resumo gerado',
          action: 'Ver resumo',
        },
        {
          title: 'Equações do 2º grau',
          detail: '1º Ano C • 48 min',
          meta: 'Transcrição salva',
          action: 'Abrir',
        },
        {
          title: 'Plano cartesiano',
          detail: '3º Ano B • 61 min',
          meta: 'Material vinculado',
          action: 'Baixar',
        },
      ],
    ...
    Configurações: {
      title: 'Configurações',
      description:
        'Defina preferências da turma, notificações, acessibilidade e padrões de resumo.',
      primaryAction: 'Salvar preferências',
      icon: 'Settings',
      rows: [
        {
          title: 'Preferências da turma',
          detail: 'Resumo automático, idioma e visualização',
          meta: 'Ativo',
          action: 'Editar',
        },
        {
          title: 'Notificações',
          detail: 'Convites, aulas e uploads',
          meta: 'E-mail habilitado',
          action: 'Configurar',
        },
        {
          title: 'Acessibilidade',
          detail: 'Contraste, tamanho de fonte e Libras',
          meta: 'Alto contraste',
          action: 'Ajustar',
        },
      ],
  ...
  async getDashboard(userId: string, role: string) {
    ...
    return {
      ...
      menuItems: menuItems.filter((item) =>
        access.sections.includes(item.label as DashboardSection),
      ),
      ...dashboardData,
      stats: dashboardData.stats.map((stat) =>
        stat.label === 'Materiais da disciplina'
          ? {
              ...stat,
              value: String(formattedMaterials.length),
              detail: 'Arquivos enviados para IA',
            }
          : stat,
      ),
      managementSections,
